    ...
    <PageMain>
        ...
        <template #body>
            ...
            <div v-else class="overflow-x-auto">
                <table
                    class="table-fixed border-separate border-spacing-0 text-sm break-keep w-full">
                    <thead>
                        <tr class="bg-elevated/50">
                            <th class="datatable-th w-[40px]"></th>
                            <th class="datatable-th">權限名稱</th>
                            <th class="datatable-th">權限代碼</th>
                            <th class="datatable-th">單元</th>
                            <th class="datatable-th">狀態</th>
                            <th class="datatable-th">操作</th>
                        </tr>
                    </thead>
...
.datatable-th {
    @apply py-2 px-4 text-left first:rounded-l-lg last:rounded-r-lg border-y border-gray-200 dark:border-gray-800 first:border-l last:border-r;
}

.datatable-td {
    @apply py-2 px-4 border-b border-gray-200 dark:border-gray-800;
}
</style>
