...
import AppHistory from "~/components/App/History/AppHistory.vue";
import AppHistoryFormPage from "~/components/App/History/FormPage.vue";
import AppVideo from "~/components/App/Video/AppVideo.vue";
import AppVideoFormPage from "~/components/App/Video/FormPage.vue";
...
export const useModuleComponent = () => {
    ...
    const moduleFormComponentMap: Record<string, any> = {
        ...
        history: AppHistoryFormPage,
        video: AppVideoFormPage
    };
