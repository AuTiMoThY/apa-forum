...
export const useUsers = () => {
    ...
    const loadDataToForm = (adminData: any) => {
        ...
        form.status =
            adminData.status === 1 || adminData.status === "1" ? true : false;
        form.username = adminData.username || "";
        form.password = "";
        form.password_confirmation = "";
        form.name = adminData.name || "";
        form.photo = adminData.photo || "";
        form.profile = adminData.profile || "";
        form.expiration_date = adminData.expiration_date || null;
        form.note_finance = adminData.note_finance || "";
        form.note_deliver = adminData.note_deliver || "";
        form.note_purchase = adminData.note_purchase || "";
